"""
Quantopian - Technical analysis Indicators without Talib (code) 
@Peter Bakker  posted Mar 17, 2015
...
def EMA(df, n):  					#指数移动平均.Exponential Moving Average  
...
def MA(df, n):  					#移动平均,Moving Average  
